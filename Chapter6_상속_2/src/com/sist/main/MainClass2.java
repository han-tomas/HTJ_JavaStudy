...
class Student extends Human
{
	 ...
	 */
	public void display() // 3. display() → display(int a)
	                      // 5. (축소) public → default (X) 
	{
...
//		Student s2=(Student) new Human(); 오류
		...
		Student s2=(Student)h2; // 정상 수행
		s2.display();
		
//		Student s2=(Student)h; ClassCastException => 형변환 오류 // 클래스와 생성자가 같아야한다. h= new Student();

 ...
 *       "홍길동"    {'홍','길','동'}
 *       
 *       String : => java.lang.String에 존재 => 라이브럴
 *       ------
 ...
 *               String s = "Hello Java";
 *               String result = s.toLowerpperCase()
 *               => result = "hello java"
 *            3) 찾기
 *               -----------
 ...
 *               ----------- 서제스트(자동 완성기)
 *               ***contains => 포함문자 (검색) => 추천 => 결과값 true/false 
 *               
 */
public class 문자열_1 {
	...
	public static void main(String[] args) {
		...
		for(char c:msg)
		{
			if(c>='a' && c<='z')// 소문자라면
			{
				System.out.print((char)(c-32)); // 소문자 - 대문자 = 32
				// 'A'(65),'a'(97) ==> 'a'-32
			}
			if(c>='A' && c<='Z')
			{

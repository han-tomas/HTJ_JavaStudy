...
public class SeoulSystem {
	...
	private int curpage; // 프로그램 종료까지 유지할 세팅 => 전역변수(멤버변수) 선언
...
//		             --------- => 28
	...
	public void process()
	{
		...
		while(true)
		{
			...
			{
				Scanner scan = new Scanner(System.in);
				System.out.print("상세히 볼 명소 번호 입력 : ");
				int no = scan.nextInt();
				System.out.println("번호 : "+ datas[no-1].getNo());
				System.out.println("번호 : "+ datas[no-1].getName());
				System.out.println("번호 : "+ datas[no-1].getAddress());
				System.out.println("번호 : "+ datas[no-1].getContent());

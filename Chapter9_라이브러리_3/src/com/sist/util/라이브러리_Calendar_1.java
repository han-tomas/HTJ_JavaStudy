...
public class 라이브러리_Calendar_1 {
	...
	public static void main(String[] args) {
		 ...
		 *   기능을 가지고있지 않다 => 인터페이스 (구현이 안된 메소드만)
		 *   List list = new ArrayList() => 인터페이스 (클래스명과 다른 생성자명으로 호출)
		 */
		System.out.println("년도 : "+cal.get(Calendar.YEAR));
		//System.out.println("년도 : "+cal.get(1)); //년도출력
		System.out.println("월 : "+(cal.get(Calendar.MONTH)+1)); // Month는 0번부터 시작

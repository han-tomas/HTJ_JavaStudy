 ...
 *        
 *        -----------------------
 *        2) 생성자 설정 => 필요시에만 사용 => 설정하지 않는 경우에는
 *                                     컴파일러가 자동으로 생성자를 만들어준다.
 *        
 *        -----------------------
 *        3)메소드 설정
 *        
 ...
 *        = 인스턴스 변수 : new를 사용할때 저장되는 변수 (new 설정에 따라 따로 저장)
 *          = 클래스객체명.변수명
 *          Card c1 =new Card()
 *               -- 변수 여러개 저장 ( . => 주소 접근 연산자)
 *          c1.number=10
 *        = 정적 변수 : 한개의 공간에 저장되는 변수 => 공통된 저장공간을 공유
 *          Card.number***
 *        ------------- 프로그램 종료시까지 사용되는 변수
 *      
 ...
 *      --------------------------------------------------- => 메모리에서 자동으로 저장      
 *      Heap: 포로그래머 영역 ( 사용자가 직접 메모리 크기를 만들어서 저장)
 ...
 *                  }
 *     --------------------------------------------------------------------------------
 *     지역변수        class ClassName       메소드 호출시마다                메소드안에서만 사용이가능
 *                  {
 *                      void display()
 *                      {
 *                          int a=10;
...
public class 사용자정의_데이터형1 {
	...
	public static void main(String[] args) {
		...
		s1.eng=80;
		s1.math=78;
		System.out.println("s1= "+s1); //주소값 출력

...
// 명사형  동사형
/*
 *   명사형: 번호 작성자 내용 제목 작성일 비밀번호 조회수 
 *   동사형: 글쓰기 수정하기 내용보기 삭제하기 조회수올리기
 *   
 *   학생 => 유형
 *   게시판 => 무형
 *   ----------- 모든것을 단순화 => 객체 지향 프로그램
 ...
 *   
 *   클래스 종류
 *  ***= 변수 여러개 저장하는 공간 => 사용자정의 데이터
 *       ~VO(Sping), ~DTO(MyBatis), ~Bean(JSP)
 *            |      data transfer object 데이터를 전송할 목적으로 만드는 것
 *       value object 값만 가지고있음
...
public class 사용자정의_데이터형2 {
	...
	public static void main(String[] args) {
		...
		b1.pwd="1234";
//		b1.hit=0; //==>0으로 자동으로 초기화 되어있기 때문에 

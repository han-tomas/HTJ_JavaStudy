...
public class MusicSystem {
	...
	Music[] music = new Music[50]; //null// Music ==> 사용자 정의 데이터형 
	// 1. 메소드 => 생성자
	void init() //리턴값이 없는 메소드(초기화)
	{
		/*
		 *    인스턴스 : 객체 생성 => 객체명.변수, 배열...
		 *    static : 객체 생성 필요X => 클래스명.변수,배열...
		 */
		for(int i=0;i<MusicData.title.length;i++) // title은 static 변수 => 그래서 클래스명.변수로 호출
		{

...
public class NaverNewsManager {
    ...
    public static List<NewsVO> newsSearchData(String fd)  {
        ...
        String clientId = "3ZyXeiAYItdSmucU7fH8"; //애플리케이션 클라이언트 아이디
        String clientSecret = "IqIOmFI7Vb"; //애플리케이션 클라이언트 시크릿
        ...
        //{	"lastBuildDate":"Tue, 09 May 2023 12:10:24 +0900",	"total":83828,	"start":1,	"display":10,	"items":[		{			"title":"롤렉스 전문점 턴 日 강

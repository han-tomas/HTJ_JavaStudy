...
public class 라이브러리_Object {
	...
	public static void main(String[] args) {
		...
		s=null; //메모리를 null값 해주면 GC 대상이 된다.
		// 메모리를 해제 => 강제로 명령
